...
//  StarbucksClone
//
//  Created by Владимир Муравьев on 25.02.2023.
//
...
class TileView: UIView {
    ...
    private func addShadow() {
        ...
        shadowLayer.shadowPath = shadowLayer.path // This is where the magic happens
        shadowLayer.shadowOffset = .init(width: 0.0, height: 1.0)
